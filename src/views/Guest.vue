        ...
        <v-row>
            <v-col cols="4">
                <v-row justify="center">
                    <v-avatar size="150" >
                        <v-img lazy-src="https://picsum.photos/500/300?random" src="https://picsum.photos/500/300?random"/>
                    </v-avatar>
                </v-row>
            </v-col>
            ...
            <v-col cols="8" xs="7" sm="7" lg="8">
                <v-row>
                    <v-col cols="12" xs="12" sm="12" md="6" lg="5">
                        <div :style="[$vuetify.breakpoint.xs ?{'max-width':'200px'}:{}]" class="text-h4 d-inline-block text-truncate">{{$route.params.id}}</div>
                    </v-col>
                    <v-col class="ml-2">
